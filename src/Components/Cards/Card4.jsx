    ...
    return(
        <Box>
          <Card sx={{height:120+'px',width:180+'vh',marginTop:3+'vh'}}>
           <Stack direction="row" padding={1}>
            <Card sx={{height:108+'px',width:110+'px',bgcolor:"#1de9b6",textAlign:"left"}}>
            ...
            <Box sx={{marginLeft:2+'vh'}}>
                ...
                <Stack direction="row">
                <Typography variant="h6">Ronald Rechards
                  </Typography>
                ...
                >updated 22 hour ago</Typography>
                </Stack>
            </Box>
        ...
        <Box >
          ...
          <StyledBox >
            ...
            <CircularProgress value={86.5} variant="determinate" size={20} />
             <Typography
            sx={{fontWeight:"bold"}}>86.5%</Typography>
            </Stack>
          </StyledBox>
